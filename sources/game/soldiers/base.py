...
class Soldier(GameObject):
    ...
    def refresh_widgets(self) -> None:
        if self.color == C.BLUE:
            ...
            self._main_widget.bind("<Enter>", self._handle_enemy_hover_event)
    ...
    def _handle_enemy_hover_event(self, event: tk.Event) -> None:
        self._main_widget.grab_set()
        self._main_widget.bind("<Leave>", self._handle_enemy_unhover_event)
    ...
    def _handle_enemy_unhover_event(self, event: tk.Event) -> None:
        self._main_widget.grab_release()
        self._main_widget.unbind("<Leave>")
